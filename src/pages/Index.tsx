...
import { Plus, Search, Filter, Grid, List, Calendar, User, Palette, Bell } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        <AppSidebar />
        <div className="flex-1 bg-gradient-to-br from-slate-50 via-white to-blue-50">
          {/* Header */}
